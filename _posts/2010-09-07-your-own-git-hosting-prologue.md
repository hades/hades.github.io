...
So how do you setup a Git hosting? There are a lot of web Git hostings ([gitorious.org](http://gitorious.org), [github.com](http://github.com)), and project hostings with Git support ([sf.net](http://sf.net)) out there. Mostly they provide free hosting for open-source projects and charge a fee for private repositories.
...
- [git-daemon](http://www.kernel.org/pub/software/scm/git/docs/git-daemon.html) for anonymous git protocol access;
